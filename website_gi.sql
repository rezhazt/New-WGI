...
INSERT INTO `tabel_login` (`idAdmin`, `username`, `passwordAdmin`) VALUES
(1, 'admin', 'ahuhah');
...
--
ALTER TABLE `tabel_kontak`
  MODIFY `idKontak` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tabel_visit`
  MODIFY `idVisitor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
COMMIT;
