...
<div style="display:block">
  <div class="container center" id="html-content-holder">
    <div id="border_tiket" style="width: 1350px; height: 1440px;">
      ...
      <div style="font-size: 45px;">
        <p>
          <u>Harap Tunjukan di gerbang Pos Security utama sebelum memasuki area perusahaan </u>
        </p>
      </div>
    </div></div></div>
  </tbody>.
