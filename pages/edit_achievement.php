...
if (isset($_POST['update'])) {
    ...
    // update user data
    $result_achievement = mysqli_query($kon, "UPDATE tabel_achievement SET judul='$judul',foto='$foto' WHERE id=$id");
...
$result_achievement = mysqli_query($kon, "SELECT * FROM tabel_achievement WHERE id=$id");

while ($dataAchieve = mysqli_fetch_array($result_achievement)) {
    $judul = $dataAchieve['judul'];
    $foto = $dataAchieve['foto'];
}
?>
<html>
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-lg-6 col-lg-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: center;">Edit Achievement</div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="edit_achievement.php" class="form" name="update_achievement" method="post">
